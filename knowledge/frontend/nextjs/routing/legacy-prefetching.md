...
- 여기서 말하는 30초는 prefetch해 온 것이 클라이언트에 얼마나 남아 있는지의 이야기다. prefetch 방식·정적/동적에 따라 그 시간이 어떻게 갈리는지는 [../caching/legacy-router-cache.md](../caching/legacy-router-cache.md)의 「Automatic Invalidation Period는 prefetch 종류·정적/동적 페이지에 따라 어떻게 다른가?」 참고.
