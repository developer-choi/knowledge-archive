...
- [What is an Array?](#what-is-an-array)
  - [What is a Subarray?](#what-is-a-subarray)
- [Why do we need Arrays?](#why-do-we-need-arrays)
- [What are the advantages of an Array?](#what-are-the-advantages-of-an-array)
  - [What is Random Access, and why is it O(1)?](#what-is-random-access-and-why-is-it-o1)
  - [Why is an Array cache-friendly?](#why-is-an-array-cache-friendly)
- [What are the disadvantages of an Array?](#what-are-the-disadvantages-of-an-array)
  - [Why is insertion/deletion O(n) in an Array?](#why-is-insertiondeletion-on-in-an-array)
    - [How does insertion position affect performance?](#how-does-insertion-position-affect-performance)
...
## What is Random Access, and why is it O(1)?
...
## Why is an Array cache-friendly?
...
## Why is insertion/deletion O(n) in an Array?
...
## How does insertion position affect performance?
