...
# Questions
- [기존의 설계 원칙(SOLID, DRY 등)이 있는데도 FSD 같은 구체적 방법론이 필요한 이유는 무엇인가?](#기존의-설계-원칙solid-dry-등이-있는데도-fsd-같은-구체적-방법론이-필요한-이유는-무엇인가)
- [FSD는 MVP 단계에서도 적용할 수 있는가? MVP에서는 아키텍처보다 기능이 중요하지 않은가?](#fsd는-mvp-단계에서도-적용할-수-있는가-mvp에서는-아키텍처보다-기능이-중요하지-않은가)
