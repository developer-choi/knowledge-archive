...
- [UNVERIFIED] 함수 대신 클래스를 선택하는 기준은?
- [UNVERIFIED] 추상화(Abstraction)와 상속(Inheritance)이 OOP에서 해결하는 문제는?
- [UNVERIFIED] 접근 제어자(Access Modifier)의 역할은?
- [UNVERIFIED] static 멤버를 사용하는 기준은?
