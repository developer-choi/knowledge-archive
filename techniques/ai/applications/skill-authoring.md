...
> #### AI Annotation:
> Claude가 이미 아는 일반 코딩 지식을 스킬에 적으면 토큰만 낭비된다.
...
> #### AI Annotation:
> gotchas = Claude가 스킬 사용 시 반복적으로 실패하는 지점 모음.
...
> #### AI Annotation:
> 지시를 너무 구체적으로 적으면 Claude의 상황 적응력이 떨어진다.
...
> #### AI Annotation:
> 사용자별 설정은 스킬 디렉토리의 config.json에 저장.
