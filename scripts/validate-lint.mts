...
const CHECK_REGISTRY: CheckSpec[] = [
  ...
  { id: 'K7', severity: 'error', rule: "document-structure '목차(TOC)와 본문 순서 동기화'" },
  ...
  { id: 'E1', severity: 'error', rule: "validate SKILL 'knowledge↔explained 셋트 규칙' — explained 커버리지" },
  { id: 'E2', severity: 'error', rule: "validate SKILL 'knowledge↔explained 셋트 규칙' — explained 고아 섹션" },
  { id: 'E3', severity: 'error', rule: "validate SKILL 'knowledge↔explained 셋트 규칙' — explained 고아 파일" },
  { id: 'E4', severity: 'error', rule: "document-structure 'explained/ 파일 구조'" },
  { id: 'E5', severity: 'error', rule: "validate SKILL 'knowledge↔explained 셋트 규칙' — knowledge 짝 부재" },
  { id: 'E6', severity: 'error', rule: "validate SKILL 'knowledge↔explained 셋트 규칙' — 질문 순서" },
